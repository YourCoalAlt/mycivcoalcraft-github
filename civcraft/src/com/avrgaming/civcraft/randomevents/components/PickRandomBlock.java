		...
		class SyncTask implements Runnable {
			...
			public void run() {
				...
				for (int i = 0; i < 10; i++) {
					...
					if (bcoord != null) { // found our block.
						break;
					}
				}
				...
				sendMessage("The block is located in the chunk "+coord.getX()+"x,"+coord.getZ()+"z between y "+y_min+" and "+y_max);
				sendMessage("(To get the actual x and z coordinates, multiply them by 16)");
			}
		}
