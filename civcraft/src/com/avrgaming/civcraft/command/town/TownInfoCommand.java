...
public class TownInfoCommand extends CommandBase {
	...
	public void area_cmd() throws CivException {
		...
		CivMessage.send(sender, CivColor.Green+"Total Chunk Count:"+CivColor.LightGreen+totalBiomes);
...
//					CivColor.LightGreen+df.format(town.getHappinessPercentage()*100)+"%");
		...
		if (resident == null || town.isInGroup("mayors", resident) || town.isInGroup("assistants", resident) || 
			...
			CivMessage.send(sender, CivColor.Green+"Treasury: "+CivColor.LightGreen+town.getBalance()+CivColor.Green+" coins. Upkeep: "+CivColor.LightGreen+town.getTotalUpkeep());
			...
			if (bank != null) { 
				CivMessage.send(sender, CivColor.Green+"Interest Rate: "+CivColor.LightGreen+df.format(((Bank)bank).getInterestRate()*100)+"% "+
						CivColor.Green+"Principal: "+CivColor.LightGreen+town.getTreasury().getPrincipalAmount()+" Coins");
			} else {
				CivMessage.send(sender, CivColor.Green+"Interest Rate: "+CivColor.LightGreen+"0% (No Bank) "+
						CivColor.Green+"Principal: "+CivColor.LightGreen+"0 Coins (No Bank)");
			}
		}
