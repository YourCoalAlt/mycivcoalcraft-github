...
//		VASSAL
	...
	public DiplomaticRelation(Civilization civ, Civilization otherCiv, Status status, Date expires) {
		this.civ = civ;
	...
	public DiplomaticRelation(ResultSet rs) throws SQLException, InvalidNameException {
		this.load(rs);
		if (this.civ != null) {
