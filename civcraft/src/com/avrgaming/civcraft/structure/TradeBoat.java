...
public class TradeBoat extends TradeOutpost {
	...
	protected TradeBoat(Location center, String id, Town town)
			throws CivException {
		super(center, id, town);
	}

	protected TradeBoat(ResultSet rs) throws SQLException, CivException {
		super(rs);
	}
	
	@Override
	public String getDynmapDescription() {
		String out = "<u><b>Trade Boat</u></b><br/>";
		return out;
	}
