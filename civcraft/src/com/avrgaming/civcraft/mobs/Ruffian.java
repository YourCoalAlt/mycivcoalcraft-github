...
public class Ruffian extends CommonCustomMob implements ICustomMob {
	...
	public void onCreateAttributes() {
		...
		case LESSER:
		    ...
		    this.addDrop("civ_ionic_crystal_fragment_1", 0.05);
			...
			this.addDrop("civ_refined_sulphur", 0.15);
		    this.coinDrop(1, 25);
		...
		case GREATER:
		    ...
		    this.addDrop("civ_ionic_crystal_fragment_2", 0.05);

		    this.addDrop("civ_carved_leather", 0.1);
		    this.addDrop("civ_crafted_string", 0.03);
		    this.addDrop("civ_refined_slime", 0.05);

		    this.addDrop("civ_varnish", 0.01);
		    this.addDrop("civ_sticky_resin", 0.01);
			this.addDrop("civ_refined_sulphur", 0.25);
		    this.coinDrop(10, 50);
		...
		case ELITE:
		    ...
		    this.addDrop("civ_ionic_crystal_fragment_3", 0.05);

		    this.addDrop("civ_leather_straps", 0.1);
		    this.addDrop("civ_crafted_string", 0.05);
		    this.addDrop("civ_refined_slime", 0.05);

		    this.addDrop("civ_varnish", 0.01);
		    this.addDrop("civ_sticky_resin", 0.01);
			this.addDrop("civ_refined_sulphur", 0.35);
		    this.coinDrop(20, 80);
		...
		case BRUTAL:
		    ...
		    this.addDrop("civ_ionic_crystal_fragment_4", 0.05);

		    this.addDrop("civ_artisan_leather", 0.1);
		    this.addDrop("civ_crafted_string", 0.1);
		    this.addDrop("civ_refined_slime", 0.05);

		    this.addDrop("civ_varnish", 0.01);
		    this.addDrop("civ_sticky_resin", 0.01);
			this.addDrop("civ_refined_sulphur", 0.50);
