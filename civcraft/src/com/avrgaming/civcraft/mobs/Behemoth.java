...
public class Behemoth extends CommonCustomMob implements ICustomMob {
	...
	public void onCreateAttributes() {
		...
		case GREATER:
		    ...
		    this.addDrop("civ_steel_plate", 0.1);
		    this.addDrop("civ_steel_ingot", 0.05);
		    this.addDrop("civ_clay_molding", 0.05);

		    this.addDrop("civ_varnish", 0.01);
		    this.addDrop("civ_sticky_resin", 0.05);
		    this.coinDrop(10, 50);
		    break;
		case ELITE:
