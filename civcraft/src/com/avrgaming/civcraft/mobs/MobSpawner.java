...
public class MobSpawner {
	...
	public static CommonCustomMob spawnCustomMob(CustomMobType type, CustomMobLevel level, Location loc) throws CivException {
		...
		EntityZombie z = new EntityZombie(mcWorld);
		z.setCustomName(CivColor.Purple+"Test Zombert");
		z.setCustomNameVisible(true);
		z.setLocation(loc.getX(), loc.getY(), loc.getZ(), loc.getPitch(), loc.getYaw());
		mcWorld.addEntity(z, SpawnReason.CUSTOM);
