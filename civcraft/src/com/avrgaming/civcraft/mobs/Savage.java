...
public class Savage extends CommonCustomMob implements ICustomMob {
	...
	public void onCreateAttributes() {
		...
		case GREATER:
		    ...
		    this.addDrop("civ_aged_wood_stave", 0.1);
		...
		case ELITE:
		    ...
		    this.addDrop("civ_varnish", 0.05);
		    this.addDrop("civ_woven_threading", 0.1);
		...
		case BRUTAL:
		    ...
		    this.addDrop("civ_longbow_stave", 0.1);
		    this.addDrop("civ_reinforced_braid", 0.15);
