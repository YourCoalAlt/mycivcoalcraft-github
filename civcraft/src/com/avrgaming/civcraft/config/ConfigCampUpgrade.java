...
public class ConfigCampUpgrade {
	...
	public void processAction(Camp camp) {
		...
		case "enable_longhouse":
			...
			break;
		case "enable_first_garden":
			camp.setFirstGardenEnabled(true);
			CivMessage.sendCamp(camp, "Our first garden has been enabled!");
			break;
		case "enable_second_garden":
			camp.setSecondGardenEnabled(true);
			CivMessage.sendCamp(camp, "Our second garden has been enabled!");
			break;
		default:
