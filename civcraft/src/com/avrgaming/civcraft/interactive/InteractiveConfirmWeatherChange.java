	...
	public void respond(String message, Resident resident) {
		...
		if (message.equalsIgnoreCase("yes")) {
			...
			try {
				...
				player.getWorld().setWeatherDuration((int) TimeTools.toTicks(20*60*5));
				CivMessage.global(resident.getName()+" has used a "+CivColor.Yellow+"Weather Change"+CivColor.RESET+" token to make the weather sunny!");
